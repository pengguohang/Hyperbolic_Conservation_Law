...
def main(args):
    ...
    # model_name: 模型名称_epochs_激活函数_ragne_模型大小_modeltype_losstype_采样_优化器
    model_name = args.model_name + '_' + str(epochs) + '_' + acti + '_' + str(range_value) + '_' + str(args.layer) + '_' + str(args.param) + '_' + args.model
...
if __name__ == "__main__":
    ...
    parser.add_argument('--param', type=int, required=True, help='128, 256, 512')
    parser.add_argument('--layer', type=int, required=True, help='4, 6')
    parser.add_argument('--model', type=str, required=True, help='MLP, ResNet')
