...
def main(args):
    ...
    model_name = args.model_name + '_entropy_' + acti + '_' + str(range_value) + '_' + str(args.layer) + '_' + str(args.param) + '_' + args.model + '_' + args.sample
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str,  default='MIX_all', help='GA or DFVM or PINNs or MIX_all or MIX_region or GA')
    ...
    parser.add_argument("--entropy", action='store_true', help='compute entropy')
